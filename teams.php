...
<?php
	...
	if ($r)
	{
		echo '<br><font color="columbia blue"><center><table border="1" cellspacing="5" cellpadding="5" ><th>Team Name</th><th>Team Points</th>';
		
		while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) 
		{
			echo'<tr><td>'.$row['TeamName'].'</td><td><center>'.$row['TeamPoints'].'</center></td></tr>';
		}//end of while
